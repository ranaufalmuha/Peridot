...
export interface BalanceQueryArgs { 'accounts' : Array<Account__3> }
...
export interface Token {
  ...
  'get_bonus' : ActorMethod<[], bigint>,
  'get_minted_count' : ActorMethod<[], bigint>,
  'get_minted_goal' : ActorMethod<[], bigint>,
